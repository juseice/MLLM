...
class LegendSettings:
    ...
    def __init__(self, legend_font_path: str = "MarkLLM/markllm/font/arial.ttf", legend_font_size: int = 12, legend_width: int = 160) -> None:
        """
...
class DiscreteLegendSettings(LegendSettings):
    ...
    def __init__(self, legend_font_path: str = "MarkLLM/markllm/font/arial.ttf", legend_font_size: int = 12, legend_width: int = 160,
