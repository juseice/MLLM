...
# Load data
with open('MarkLLM/markllm/dataset/c4/processed_c4.json', 'r') as f:
    lines = f.readlines()
    lines = [json.loads(line) for line in lines[:100]]
...
def main(algorithm_name, model_path):
    ...
    watermark = AutoWatermarkForVLLM(algorithm_name=algorithm_name, algorithm_config=f'MarkLLM/markllm/config/{algorithm_name}.json', transformers_config=transformers_config)
